...
$sql = "select dish.*,category.category,course.course from dish,category,course where dish.category_id=category.id and dish.course_id=course.id order by dish.id desc";
