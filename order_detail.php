...
if (isset($_GET['id']) && $_GET['id'] > 0) {
	...
	where order_master.order_status=order_status.id and order_master.id='$id' 
		...
		<div class="card px-2">
			<div class="card-body">
				<div class="container-fluid">
					<h3 class="text-center ">Order ID&nbsp;&nbsp;<?php echo $id ?></h3>
					<hr>
				</div>
				<div class="container-fluid d-flex justify-content-between">
					<div class="col-lg-3 pl-0">
						<p class="mt-5 mb-2"><b>Eternity Cafe</b></p>
						<p class="mb-0 mt-5">Order Date : <?php echo dateFormat($orderRow['added_on']) ?></p>

					</div>
					<div class="col-lg-3 pr-0">
						<p class="mt-5 mb-2 text-right"><b>Deliver to</b></p>
						<p class="text-right">
